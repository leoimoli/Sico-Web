    ...
    <div class="col-md-9 col-sm-9 col-xs-9">
        <div>
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        <asp:Label ID="lblMensaje" runat="server" Text="No se encontraron resultados para los parametros seleccionados." Font-Size="Large" ForeColor="Red"></asp:Label>
                    </div>
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="form-group">
                            <asp:GridView ID="gvPeriodos" runat="server" Align="center" AllowPaging="true" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NombrePeriodo" HeaderText="Nombre Per{iodo">
                            ...
                            <div id="totales" class="total">
                                <asp:Label ID="lblTotal" runat="server" CssClass="total" Text="Total:"></asp:Label>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <div class="col-md-9 col-sm-9 col-xs-9" style="padding-left: 460px">
                    <asp:Button ID="btnGuardar" class="btn btn-primary" Style="display: inline-block;" Width="110px" Height="61px" runat="server" Text="Guardar" Font-Size="Small" />
                </div>
            </div>
        </div>
    </div>
